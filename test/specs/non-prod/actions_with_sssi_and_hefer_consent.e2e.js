...
describe('Actions that require SSSI and HEFER Consent @cdp @dev', () => {
  describe('Given farmer is eligible for funding', () => {
    describe('When farmer goes through the land grants application', () => {
      ...
      it('Then the farmer says No to add another action to the land parcel, is shown SSSI & HEFER consent page', async () => {
        ...
        await YouMustHaveConsentPage.validateSssiAndHeferConsentContent()
